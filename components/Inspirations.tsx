    ...
    <section className="py-16 md:py-32 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-10 md:mb-20">
            <h2 className="text-3xl md:text-5xl font-serif text-[#0d5c63] mb-4 md:mb-6">Inspirations</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12">
          {INSPIRATIONS.map((item, idx) => (
            <div key={idx} className="group cursor-pointer">
              ...
              <h3 className="text-xl md:text-2xl font-serif font-bold text-slate-800 mb-2 md:mb-4 group-hover:text-[#0d5c63] transition-colors">{item.title}</h3>
              <p className="text-slate-500 text-xs md:text-sm leading-relaxed mb-4 md:mb-6 line-clamp-3 italic">
                {item.excerpt}
              </p>
              <button className="flex items-center gap-2 text-[#0d5c63] font-bold text-[10px] md:text-xs uppercase tracking-widest">
        ...
        <div className="mt-16 md:mt-40 border-t border-slate-100 pt-12 md:pt-32 text-center">
            <h3 className="text-2xl md:text-3xl font-serif text-slate-800 mb-6 md:mb-12">#villaysluxury</h3>
            ...
            <button className="mt-8 md:mt-12 text-slate-400 font-bold text-[10px] md:text-xs uppercase tracking-[0.2em] md:tracking-[0.3em] hover:text-[#0d5c63] transition-colors">
                Follow our journey
            </button>
        </div>
      </div>
